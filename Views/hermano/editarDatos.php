...
<body>
    ...
    <p class="info">En este apartado podrás cambiar tus datos en los siguientes campos</p>
    <form action="<?= $_ENV['BASE_URL']?>hermano/editarDatos/<?= $hermano->id ?>" method="POST" class="formEditar">
